...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Data Project Pipeline",
    Description = "Create a data pipeline for the data portal project",
    `Authors@R` = c(
      person("Chris", "Selig", email = "chris@selica.ca", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  ),overwrite = TRUE
)
# Define License with use_*_license()
usethis::use_proprietary_license("Chris Selig")
```
...
```{r, eval=FALSE}
# Not needed since already using git
# usethis::use_git()
...
fusen::inflate(flat_file = "dev/pipeline.rmd", vignette_name = "Minimal",overwrite = TRUE)
```
